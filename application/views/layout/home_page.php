...
<head>
    <meta charset="utf-8">
    <title><?php echo $judul_browser;?> - Siskop RBS</title>
	...
	<?php } ?>
    <script src="<?php echo base_url(); ?>assets/component/theme_admin/js/jquery.min.js"></script>
    ...
    <nav class="navbar navbar-default navbar-static-top m-b-0">
        ...
        <ul class="nav navbar-top-links navbar-right pull-right">
            ...
            <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><i class="fa fa-fax"></i><div class=""><span class=""></span><span class="point"></span></div></a>
                ...
                <!-- Profile Pic-->
                <li class="dropdown"><a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"><img src="<?php echo base_url();?>assets/layout/img/avatar-admin.png" alt="avatar-admin" width="36" class="img-circle"><b class="hidden-xs"><?php echo $this->session->userdata('u_name');?></b></a>
       ...
       <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title"><?php echo $judul_utama; ?>
                    <small><?php echo $judul_sub; ?></small></h4>
                </div>
